...
;(function($){
					...
					google.maps.event.addListener(gmarker, 'click', function(e) {
						 var infoContent = '<div class="gmap-infobox">\
								<div class="property-item-map-wrap">\
									<a class="info-close" onclick="return infoBox.close();" href="javascript:void(0)"><img src="//www.google.com/intl/en_us/mapfiles/close.gif" align="right" /></a>\
									<div class="property-item-map">\
										...
										<div class="content">\
											...
											<div class="action">\
												<div class="price">\
													<span class="amount">' + this.price_html + '</span>\
												</div>\
	...
	$(document).on('click','.gmap-full',function(e){
		...
		if($(this).closest('.noo-map').hasClass('fullscreen')){
			...
			$(this).empty().html('<i class="fa fa-expand"></i>Fullscreen '+nooGmapL10n.fullscreen_label);
		}else{
			$(this).closest('.noo-map').addClass('fullscreen');
			$(this).empty().html('<i class="fa fa-compress"></i>Exit '+nooGmapL10n.default_label);
		}
